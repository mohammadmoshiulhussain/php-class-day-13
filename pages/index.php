                ...
                <nav class="navbar navbar-expand-sm navbar-dark bg-dark">
                    <div class="container">
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li><a href="" class="nav-link text-white">String</a></li>
                            <li><a href="" class="nav-link text-white">Array</a></li>
                        </ul>
                    </div>
                </nav>
                                    ...
                                    <div class="card-body">
                                        <form action="action.php" method="POST">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <label><input type="radio" name="odd_even" value="1"/>Odd</label>
                                                    <label><input type="radio" name="odd_even" value="2"/>Even</label>
                                                </div>
                                            </div>
                                            <div class="form-group row">
